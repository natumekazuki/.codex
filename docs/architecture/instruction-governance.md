...
- Skillは対象workflowの操作手順を定義するが、共通authorityやstanding authorizationを再定義しない。runtime-managed Skillのschema、target、idempotency、effect、retry、fallbackは`AGENTS.md`へ複製しない
