...
- User-facing format: `skills/review-test-value/references/comment-format-v2.md`
- Projection and diagnostics: `skills/review-test-value/scripts/extract_test_values.py`
