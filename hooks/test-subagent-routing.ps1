...
foreach ($mode in $modes) {
    ...
    foreach ($agentName in $rolesToExercise) {
    ...
    Write-Host "OK: UserPromptSubmit and routing role classes in $mode mode"
}
